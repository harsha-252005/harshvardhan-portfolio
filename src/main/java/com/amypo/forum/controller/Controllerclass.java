...
public class Controllerclass {
    ...
    public String updateTopicRecords(@PathVariable int topicId,@RequestBody TopicsEntity data3) {
    ...
    public String deleteCommentRecordId(@PathVariable int id) {
    	return service.deleteCommentRecordById(id);
    }
    
    @PutMapping("/updatecommentrecord/{post_id}")
    public String updateCommentRecords(@PathVariable int id,@RequestBody CommentEntity data5) {
    ...
    public String deleteBadgeRecordId(@PathVariable int badge_id) {
    	return service.deleteBadgeRecordById(badge_id);
    }
    
    @PutMapping("/updatebadgerecord/{post_id}")
    public String updateBadgeRecords(@PathVariable int badge_id,@RequestBody BadgeEntity data6) {
    ...
    public String updateAdminRecords(@PathVariable int id,@RequestBody AdminEntity data7) {
