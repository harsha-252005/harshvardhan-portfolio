        ...
        <section id="about" className="snap-section relative !justify-center overflow-y-auto md:overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-6xl flex flex-col items-center px-6 py-16 md:py-40 space-y-20 md:space-y-48">
                ...
                <div className="grid md:grid-cols-3 gap-6 md:gap-10 w-full max-w-5xl">
                    {coreIdentityPoints.map((point, i) => (
                        <motion.div
                            ...
                            className="cyber-card p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] border-white/5 hover:border-neon-primary/30 flex flex-col items-center text-center group"
                        >
                            <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-5 md:mb-6 group-hover:scale-110 group-hover:border-neon-primary transition-all duration-500 shadow-[0_0_25px_rgba(255,255,255,0.05)]">
                                {point.icon}
                            </div>
                            <h4 className="text-white font-black uppercase text-xs md:text-base mb-3 md:mb-4 tracking-[0.2em]">{point.label}</h4>
                            <p className="text-text-muted text-[10px] md:text-[12px] leading-relaxed tracking-wide px-1 md:px-2">{point.desc}</p>
                        </motion.div>
                    ))}
                </div>
                ...
                <motion.div
                    ...
                    className="cyber-card p-8 md:p-16 rounded-[2.5rem] md:rounded-[3.5rem] w-full max-w-4xl relative overflow-hidden group bloom-neon"
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8 md:gap-14 relative z-10">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <p className="text-neon-secondary mb-5 md:mb-8 font-black uppercase tracking-[0.4em] md:tracking-[0.6em] text-[8px] md:text-[10px] opacity-70">
                                Coimbatore — SKCET
                            </p>
                        ...
                        <div className="relative group/badge mt-4 md:mt-0">
                            ...
                            <div className="relative px-8 md:px-12 py-5 md:py-8 rounded-[1.5rem] md:rounded-[2.5rem] bg-cyber-bg/80 border-2 border-neon-primary/40 text-neon-primary font-black text-3xl md:text-5xl shadow-[0_0_30px_rgba(255,0,127,0.2)] transform rotate-3 group-hover:rotate-0 transition-all duration-500">
                                8.0 <span className="text-[9px] block opacity-50 uppercase tracking-[0.1em] mt-1 italic">CGPA</span>
                            </div>
                        </div>
                    </div>
                </motion.div>
